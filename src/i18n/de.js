export default {
  ...
  hero: {
    pill: "PFERDEREVOLUTION",
    line1: "VERWALTEN SIE IHR GESTÜT",
    line2: "WIE DIE PROFIS",
    desc: "Vergessen Sie das Chaos: Digitalisieren Sie Ihr Gestüt, kontrollieren Sie Pferde, Gesundheit und Team in Echtzeit. Handicapp gibt Ihnen die Macht der Besten, mit KI und automatischen Berichten. Bereit, Ihr Management zu transformieren?",
    ...
    plans: [
      {
        name: "Starter",
        price: "29",
        feat: ["Bis 10 Pferde", "Dashboard", "Gesundheit", "Benachrichtigungen", "Email Support"]
      },
      {
        name: "Professional",
        price: "79",
        feat: ["Bis 50 Pferde", "Alle Funktionen", "Wettbewerbe", "Berichte", "KI-Assistent", "Prioritäts-Support"]
      },
      {
        name: "Enterprise",
        price: "199",
        feat: ["Unbegrenzte Pferde", "Mehrere Einrichtungen", "API Integration", "Dedizierter Manager", "Persönliches Onboarding", "24/7 Support"]
      }
    ]
  },
